...
if __name__ == "__main__":
    json_dir = "/home/PKing/nasdata/dataset-dmai/AIJE/dataset/aije-outdoor-det/dataset-v1/json"
    ...
    lm.build_dataset(out_root, class_dict=class_dict, vis=True, crop=False)
