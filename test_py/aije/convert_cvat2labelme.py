...
if __name__ == "__main__":
    image_dir = "/home/PKing/nasdata/dataset-dmai/AIJE/dataset/aije-v2-det/dataset-v24/JPEGImages"
    anno_dir = os.path.join(os.path.dirname(image_dir), "xml")
    json_dir = os.path.join(os.path.dirname(image_dir), "json")
    convert_cvat2labelme.convert_cvat2labelme(image_dir=image_dir, anno_dir=anno_dir, out_dir=json_dir, vis=False)
