...
def android_gif():
    ...
    video_file = "/home/dm/nasdata/dataset/tmp/face_person/model/face-person/test-result/face-person-android-v1.mp4"
    video_utils.video2gif(video_file, interval=6, func=resize_android, fps=7, use_pil=False, vis=True)


def python_gif():
    video_file = "/home/dm/nasdata/dataset/tmp/face_person/model/face-person/test-result/face-person-v2.avi"
