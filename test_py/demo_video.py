...
if __name__ == "__main__":
    video_file = "/home/dm/nasdata/dataset/csdn/face_person/demo/android-demo1.mp4"
    # video_utils.video2frames(video_file, interval=2, func=None, vis=True)
    video_utils.video2gif(video_file, interval=6, func=resize_fun, fps=5, use_pil=False, vis=True)
