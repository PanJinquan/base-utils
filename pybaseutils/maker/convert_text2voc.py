...
def convert_text2voc(filename, out_xml_dir, out_image_dir=None, class_name=None, flag="", vis=True):
...
if __name__ == "__main__":
    filename = "/home/dm/nasdata/dataset/csdn/helmet/SafetyHelmetWearingDataset/train.txt"
    out_xml_dir = "/home/dm/nasdata/dataset/csdn/helmet/SafetyHelmetWearingDataset/VOC/Annotations"
    out_image_dir = "/home/dm/nasdata/dataset/csdn/helmet/SafetyHelmetWearingDataset/VOC/JPEGImages"
    flag = "v1"
    class_name = {0: "hat", 1: "person"}
    convert_text2voc(filename, out_xml_dir, out_image_dir=out_image_dir, class_name=class_name, flag="", vis=False)
