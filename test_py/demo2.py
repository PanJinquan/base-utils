...
if __name__ == '__main__':
    image_file = "/home/PKing/Downloads/34.jpg"
    image_outs = "/home/PKing/Downloads/result.jpg"
    image = cv2.imread(image_file)
    image = image_utils.resize_image(image, (64, 64))
    image = cv2.blur(image, (7, 7))
    cv2.imwrite(image_outs, image)
