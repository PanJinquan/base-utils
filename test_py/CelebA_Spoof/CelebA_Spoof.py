...
def read_annotation(image_file, boxes_file, annotation):
    ...
    boxes = image_utils.xywh2xyxy(rects).tolist()
...
if __name__ == '__main__':
    anno_file = "/home/PKing/nasdata/dataset/tmp/Anti-Spoofing/CelebA-Spoof/CelebA_Spoof/metas/intra_test/train_label.json"
    # anno_file = "/home/PKing/nasdata/dataset/tmp/Anti-Spoofing/CelebA-Spoof/CelebA_Spoof/metas/intra_test/test_label.json"
    image_dir = "/home/PKing/nasdata/dataset/tmp/Anti-Spoofing/CelebA-Spoof/CelebA_Spoof"
    CelebA_Spoof_Dataset(anno_file, image_dir)
