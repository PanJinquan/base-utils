...
def android_gif():
    ...
    video_file = "/home/PKing/nasdata/dataset/tmp/2DPose/demo/android-2dpose-demo-v2.mp4"
    video_utils.video2gif(video_file, interval=3, func=resize_android, fps=10, use_pil=False, vis=True)


def python_gif():
    video_file = "/home/PKing/nasdata/dataset/tmp/2DPose/demo/python-2dpose-demo-v2.avi"
    video_utils.video2gif(video_file, interval=5, func=resize_fun, fps=10, use_pil=False, vis=True)
